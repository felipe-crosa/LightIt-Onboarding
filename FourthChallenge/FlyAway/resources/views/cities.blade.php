<x-layout>
    ...
    <div class="flex flex-col mt-10">
        <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block py-2 min-w-full sm:px-6 lg:px-8">
                <div class="overflow-hidden shadow-md rounded-lg bg-gray-800 ">
                    <table class="min-w-full" id="citiesTable">
        ...
        <div class="mt-10 bg-slate-400 rounded-xl w-2/5 mx-auto">
            ...
            <div class=" h-20 my-5">
                <form id="addCityForm" method="POST" action="/cities" class="py-5 self-center inline-flex items-baseline">
                    @csrf
                    <label class="ml-4 mr-8 text-sm font-medium  whitespace-nowrap text-white uppercase">City name:</label>
                        <div>
                        <input id="name" required name="name" class="border border-gray-200 p-2 rounded" value="{{old('name')}}" type="text" /> 
                        @error('name')
